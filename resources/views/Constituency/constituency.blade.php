        ...
        <section role="main" class="content-body pb-0" > 
			...
			<section class="card">
				...
				<div class="card-body">
					...
					<table class="table table-responsive-md table-hover mb-0" id="datatable-default">
						<thead>
							<tr>
						...
						<tbody>
							@forelse($constituencies as $constituency )
								<tr>
									...
									<td width="10%"><a class="btn btn-danger" data-toggle="modal" data-target="#modalBootstrap{{ $constituency->Constituency_id }}" href="#">Delete</a></td>
								</tr>

								<!-- Modal -->
								<div class="modal" id="modalBootstrap{{ $constituency->Constituency_id }}" tabindex="-1" role="dialog">
